...
\typeout{Combining Feature Engineering and Structured Neural Networks for Parkinson's Disease Diagnosis.}
...
\title{Combining Feature Engineering and Structured Neural Networks for Parkinson's Disease Diagnosis.}
\author{Max Wang\\ 
...
\begin{abstract}
No objective tests for Parkinson's disease (PD) diagnosis currently exists, and studies suggest an expert misdiagnosis rates of up to 34 percent. Machine learning presents an opportunity to improve current diagnosis rates, however data is limited in scale, and the 
