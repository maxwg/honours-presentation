...
We also explored some feature engineering work in the Interspeech challenges which focus on tasks such as emotion recognition and speaker trait recognition~\cite{is2009}. The features and approaches to these challenges are undoubtedly relevant to PD diagnosis via speech. In our limited exploration of the Geneva~\cite{geneva} and ComParE~\cite{is2013} feature sets, we obtained signficiantly better results for 
