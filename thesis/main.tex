...
\specialcellright{\hspace{2em}Lyapunov\\Exponents~\cite{eckmann1986liapunov}} & Characterises the divergence of systems with close initial conditions. The largest exponent (LLE)~\cite{dingwell2000nonlinearlyapunov} is generally the most informative. \\
...
\begin{table}[h]
\caption{Cross validation results of a SVM using Tsanas' 10 feature ReliefF subset (fig \ref{tsanasresults}). Presented as mean $\pm$ stdev.}
...
\begin{tabular}{lcl}\hhline{~|*{2}{-}}
	...
	\multicolumn{2}{l}{Sensitivity (TP)}                                                                         & $56.4\pm4.7$\%                                              \\
	\multicolumn{2}{l}{Specificity (TN)}                                                                         & $73.0\pm4.4$\%                                               \\
	\multicolumn{2}{l}{AUC}                                                                         & 69.4$\pm$4.8\%                                             
\end{tabular}
& &
\begin{tabular}{lcl}\hhline{~|*{2}{-}}
\multicolumn{1}{l|}{}                                 & \multicolumn{1}{l|}{\cellcolor[HTML]{EFEFEF}Pred PD} & \multicolumn{1}{l|}{\cellcolor[HTML]{EFEFEF}Pred C} \\ \hline
...
\multicolumn{2}{l}{Sensitivity (TP)}                                                                         & $0\pm0$\%                                              \\
\multicolumn{2}{l}{Specificity (TN)}                                                                         & $100\pm0$\%                                              \\
\multicolumn{2}{l}{AUC}                                                                         & 72.1$\pm$4.8\%                                              
\end{tabular}
\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}[t]{c c c}
		...
		\begin{tabular}{lcl}\hhline{~|*{2}{-}}
			...
			\multicolumn{2}{l}{Sensitivity (TP)}                                                                         & 62.9$\pm$4.8\%                                              \\
			\multicolumn{2}{l}{Specificity (TN)}                                                                         & 75.6$\pm$4.2\%                                              \\
			\multicolumn{2}{l}{AUC (TN)}                                                                         & 75.7$\pm$3.4\%                                                     
		\end{tabular}
		& &
		\begin{tabular}{lcl}\hhline{~|*{2}{-}}
			\multicolumn{1}{l|}{}                                 & \multicolumn{1}{l|}{\cellcolor[HTML]{EFEFEF}Pred PD} & \multicolumn{1}{l|}{\cellcolor[HTML]{EFEFEF}Pred C} \\ \hline
			...
			\multicolumn{2}{l}{Sensitivity (TP)}                                                                         & $18.7\pm4.2$\%                                              \\
			\multicolumn{2}{l}{Specificity (TN)}                                                                         & $97.6\pm0.9$\%                                              \\
			\multicolumn{2}{l}{AUC (TN)}                                                                         & 76.7$\pm$2.9\%                                                     
		\end{tabular}
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}[t]{c c c}
		...
		\begin{tabular}{lcl}\hhline{~|*{2}{-}}
			...
			\multicolumn{2}{l}{AUC (TN)}                                                                         & 72.1$\pm$4.8\%                                                     
		\end{tabular}
		& &
		\begin{tabular}{lcl}\hhline{~|*{2}{-}}
			\multicolumn{1}{l|}{}                                 & \multicolumn{1}{l|}{\cellcolor[HTML]{EFEFEF}Pred PD} & \multicolumn{1}{l|}{\cellcolor[HTML]{EFEFEF}Pred C} \\ \hline
...
\section{Dynamical Systems Features}
\label{databoosting}
...
\begin{table}[h]
	\caption{Cross validation results for a SVM when including the non-linear features. Adding the dynamical features improves model performance on the accelerometer and phonation data with a Bayes factor of X and Y respectively.}
	...
	\begin{tabular}[t]{c c c}
		...
		\begin{tabular}{@{}rcccc@{}}
			&  DREAM & \begin{tabular}[c]{@{}c@{}}Dynamical \\ Only\end{tabular} & Both \\ \midrule
			...
			AUC (\%)         &      $72.1\pm4.8$ &                       $71.3\pm4.5$                                  &     $74.8\pm4.1$\\ \midrule
		\end{tabular}
		&
		\begin{tabular}{@{}cccc@{}}
			Tsanas & \begin{tabular}[c]{@{}c@{}}Dynamical \\ Only\end{tabular} & Both \\ \midrule
