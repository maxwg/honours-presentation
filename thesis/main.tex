...
The models replicated in the previous section clearly perform below the reported level of their respective papers. This disparity is possibly caused by differences in dataset quality, particularly in ensuring that the task is performed correctly or consistently. It is also likely that introducing a greater diversity of subjects increases the problem difficulty as there are natural variances in speech and gait. 
...
\begin{figure}[h]
	\caption{Standard Deviation of the fundamental frequency during vowel phonation. Females exhibit notably higher variations in $f_0$ compared to males whereas the line between PD and control is less clear.}
...
benba2014mfcc distinguishes PD with a 82\% success rate using MFCC


\subsection{Movement}

\subsection{Conclusions}
Features very non-linear... not suitable for simple models.
