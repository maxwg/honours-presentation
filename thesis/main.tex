...
%\footnote{Accurate estimations of additional Lyapunov exponent`s generally require known equations describing the system~\cite{lyapunovall}. Eckmann's algorithm~\cite{eckmann1986liapunov} can roughly estimate these exponents.}
